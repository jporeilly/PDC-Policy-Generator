...
**Version:** 0.1.0 · targets **Pentaho Data Catalog 11.0.0** (public API v3)
...
Early scaffold: the **author** stage works end-to-end from a real Registry
and is covered by the offline selftest. Reconcile, deploy and drift-check
are the roadmap, in that order — drift needs deployed methods to check,
which needs reconcile-and-deploy first.
